...
namespace SequentialTaskQueue
{
		...
		: MFiles.VAF.Core.ConfigurableVaultApplicationBase<Configuration>, IUsesTaskQueue
	{
		...
		/// <summary>
		/// Registers a Vault Extension Method with name "AddItemToSequentialQueue".
		...
		[VaultExtensionMethod("AddItemToSequentialQueue",
		...
		public const string ConfigurationBroadcastTaskQueueId =
			"MFiles.Samples.SequentialTaskQueue.Application.ConfigurationTaskQueueId";
